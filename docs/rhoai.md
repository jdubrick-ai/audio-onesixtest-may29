...
3) Access the `workbench` named `audio-onesixtest-may29-notebook`.
...
5) In the terminal, run `cd audio-onesixtest-may29` to navigate to your sample app's directory.
